...
export default function CrickVoiceAI() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const finished = sessionStorage.getItem("crickvibe_intro_finished") === "true";
    ...
    <div className="relative min-h-screen bg-[#05070f] text-gray-100 flex flex-col font-sans overflow-x-hidden selection:bg-[#c5f82a]/30">
      ...
      <AnimatePresence mode="wait">
        {!introFinished && (
          ...
          >
            <FramePlayer onIntroFinished={() => setIntroFinished(true)} />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      >
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-mono font-black text-xl tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-white via-gray-100 to-neon-volt">
                CRICKVIBE <span className="text-neon-green">AI</span>
              </h1>
          ...
          <section className="py-16 md:py-24 flex flex-col items-center text-center relative">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight leading-none text-white mb-6 uppercase">
                CrickVibe <span className="bg-clip-text text-transparent bg-gradient-to-r from-neon-green via-neon-volt to-gold relative">AI</span> Commentary
              </h1>
              ...
              {/* CTA Modes selector */}
              <div ref={controllerSectionRef} className="inline-flex p-1.5 rounded-full bg-[#0f111a] border border-white/10 items-center gap-2 relative shadow-[0_15px_35px_rgba(0,0,0,0.8)] mt-4">
                <button
                  type="button"
                  onClick={() => {
                    setActiveMode("video");
                  ...
                  className={`px-8 py-3 rounded-full text-xs font-mono font-bold tracking-widest uppercase transition-all duration-300 flex items-center gap-2 cursor-pointer z-10 ${
                    activeMode === "video" 
                      ? "bg-[#c5f82a] text-black shadow-[0_0_20px_rgba(197,248,42,0.4)] scale-105" 
                    ...
                    <form onSubmit={handleGenerateMatchAnalysis}>
                      ...
                      <div className="flex justify-end pt-6 border-t border-white/5 gap-4 mt-6">
                        <button
                          ...
                          className="px-6 py-3.5 rounded-xl border border-white/5 hover:bg-white/5 transition-all text-xs font-mono tracking-wider uppercase text-gray-450 cursor-pointer"
                        >
                          Reset
                        </button>
                      ...
                      <div className={`glass-panel p-5 rounded-2xl border border-white/5 flex flex-col justify-between overflow-hidden relative group ${matchAnalysisResult.tension >= 80 ? 'shake-tension border-red-500/20' : ''}`}>
                        ...
                        <div>
                          ...
                          <div className="my-2">
                            ...
                            <p className="text-[11px] text-gray-550 mt-2.5 leading-relaxed font-mono">
                        ...
                        <div>
                          ...
                          <div className="my-2">
                            <div className="flex items-center justify-between text-xs mb-1">
                              <span className="text-gray-550 font-mono">Outcome volatility</span>
        ...
        <footer className="relative w-full max-w-7xl mx-auto px-6 py-8 mt-auto z-20 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-gray-500">
          <div>
            <p>© 2026 CrickVibe AI. All rights reserved.</p>
